            ...
            <md-card>
                ...
                <md-card-content>
                    <md-field>
                        ...
                        <md-input type="number" v-model="cedula"/>
                    </md-field>
                    <md-field>
                        <label for="nombre">Nombre</label>
                        <md-input type="text" v-model="nombre"/>
                    </md-field>
                    <md-field>
                        <label for="apellido">Apellido</label>
                        <md-input type="text" v-model="apellido"/>
                    </md-field>
                    <md-field>
                        <label for="sexo">Sexo</label>
                        <md-select v-model="sexo" name="sexo" id="sexo">
                            <md-option v-for="sexo in sexos" value="sexo.valor" :key="sexo.id">{{sexo.valor}}
                            </md-option>
                        </md-select>
                    </md-field>
                </md-card-content>
